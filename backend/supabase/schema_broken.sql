...
-- User Profiles:
-- Avoid querying user_profiles from its own policy to prevent infinite recursion.
-- Admin-level profile management should go through backend service-role APIs.
